@echo off > NUL
ECHO ===This utility will install the Xfce4_Session_Automator Ubuntu 20.04 LTS (WSL edition) prerequisites for Windows 10=== 
...
PAUSE
cd %programfiles% && Powershell.exe -Executionpolicy  remotesigned -File  "C:\Program Files\Xfce4_Session_Automator\application\ubuntu_2004\windows_prerequisites_ubuntu_2004.ps1"
ECHO ===This utility will install the Xfce4_Session_Automator Ubuntu 20.04 LTS (WSL edition) prerequisites for Windows 10===
