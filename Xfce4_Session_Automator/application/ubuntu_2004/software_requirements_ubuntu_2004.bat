...
ECHO WARNING: In this window, please  enter 'cd $HOME ; sudo ./xfce4_automatic_theme_apply_ubuntu_2004.sh' in a TERMINAL (copy and paste) to apply all theme settings automatically.
...
PAUSE
"C:\PROGRA~1\Xfce4_Session_Automator\launchers\ubuntu_2004.lnk"
