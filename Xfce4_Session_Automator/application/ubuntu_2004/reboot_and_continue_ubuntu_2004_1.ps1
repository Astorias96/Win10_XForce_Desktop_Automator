...
Unregister-ScheduledTask -TaskName 1_RAC_U2004 -Confirm:$false
...
#Import and register a scheduled task (2) (will be removed and unregistered in reboot_and_continue_ubuntu_2004_2.ps1)
Register-ScheduledTask -xml (Get-Content 'C:\Program Files\Xfce4_Session_Automator\application\ubuntu_2004\2_RAC_U2004.xml' | Out-String) -TaskName "2_RAC_U2004" -TaskPath "\Xfce4_Session_Automator\Ubuntu_2004" –Force -User $env:COMPUTERNAME\$env:USERNAME
...
rm "C:\Program Files\ubuntu_2004.appx"
...
Write-Warning 'In the next operation Ubuntu 20.04 LTS (WSL Edition) will be installed. You will get promped to CREATE an user. Type EXIT and press Enter to continue the operations.'
Write-Warning 'If you already have an user and installed Ubuntu 20.04 LTS, type EXIT and press Enter to continue the installation.'
pause
...
$env:ProgramFiles
cls
Write-Warning '==59%== - Ubuntu 20.04 LTS (WSL Edition) was installed on this computer.'
Write-Warning 'Be sure that Ubuntu 20.04 completed the installation before continuing. A RESTART is needed.'
