#Enable Logging
Start-Transcript -Path "C:\Program Files\Xfce4_Session_Automator\transcripts\windows_prerequisites_ubuntu1804_ps1.txt" -IncludeInvocationHeader -Append
cls
...
#Import and register a scheduled task (1) (will be removed and unregistered in reboot_and_continue_ubuntu_1804_1.ps1)
Register-ScheduledTask -xml (Get-Content 'C:\Program Files\Xfce4_Session_Automator\application\ubuntu_1804\1_RAC_U1804.xml' | Out-String) -TaskName "1_RAC_U1804" -TaskPath "\Xfce4_Session_Automator\Ubuntu_1804" –Force -User $env:COMPUTERNAME\$env:USERNAME
