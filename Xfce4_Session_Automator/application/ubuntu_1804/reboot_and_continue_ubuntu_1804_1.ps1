...
Unregister-ScheduledTask -TaskName 1_RAC_U1804 -Confirm:$false
...
#Import and register a scheduled task (2) (will be removed and unregistered in reboot_and_continue_ubuntu_1804_2.ps1)
Register-ScheduledTask -xml (Get-Content 'C:\Program Files\Xfce4_Session_Automator\application\ubuntu_1804\2_RAC_U1804.xml' | Out-String) -TaskName "2_RAC_U1804" -TaskPath "\Xfce4_Session_Automator\Ubuntu_1804" –Force -User $env:COMPUTERNAME\$env:USERNAME
...
Add-AppxPackage .\ubuntu_1804.appx
rm "C:\Program Files\ubuntu_1804.appx"
...
Write-Warning 'In the next operation Ubuntu 18.04 LTS (WSL Edition) will be installed. You will get promped to CREATE an user. Type EXIT and press Enter to continue the operations.'
Write-Warning 'If you already have an user and installed Ubuntu 18.04 LTS, type EXIT and press Enter to continue the installation.'
pause
...
$env:ProgramFiles
cls
Write-Warning '==59%== - Ubuntu 18.08 LTS (WSL Edition) was installed on this computer.'
Write-Warning 'Be sure that Ubuntu 18.04 completed the installation before continuing. A RESTART is needed.'
