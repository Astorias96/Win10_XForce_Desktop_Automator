#Enable Logging
Start-Transcript -Path "C:\Program Files\Xfce4_Session_Automator\transcripts\windows_prerequisites_ubuntu1604_ps1.txt" -IncludeInvocationHeader -Append
cls
...
#Import and register a scheduled task (1) (will be removed and unregistered in reboot_and_continue_ubuntu_1604_1.ps1)
Register-ScheduledTask -xml (Get-Content 'C:\Program Files\Xfce4_Session_Automator\application\ubuntu_1604\1_RAC_U1604.xml' | Out-String) -TaskName "1_RAC_U1604" -TaskPath "\Xfce4_Session_Automator\Ubuntu_1604" –Force -User $env:COMPUTERNAME\$env:USERNAME
