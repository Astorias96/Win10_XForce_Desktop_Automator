...
Unregister-ScheduledTask -TaskName 2_RAC_U1604 -Confirm:$false

#Execute linux distribution prerequisites & KUIP
$env:ProgramFiles
cls
Write-Warning '==100%== - The Windows 10 prerequisites were sucessfully installed. By pressing Enter another window will pop-up and guide you through the Ubuntu 16.04 software requirements setup.'
pause
Start-Process 'C:\Program Files\Xfce4_Session_Automator\application\ubuntu_1604\software_requirements_ubuntu_1604.bat'
