#Enable Logging
Start-Transcript -Path "C:\Program Files\Xfce4_Session_Automator\transcripts\windows_prerequisites_debian_ps1.txt" -IncludeInvocationHeader -Append
cls
...
#Import and register a scheduled task (1) (will be removed and unregistered in reboot_and_continue_debian_1.ps1)
Register-ScheduledTask -xml (Get-Content 'C:\Program Files\Xfce4_Session_Automator\application\debian\1_RAC_DEBIAN.xml' | Out-String) -TaskName "1_RAC_DEBIAN" -TaskPath "\Xfce4_Session_Automator\Debian" –Force -User $env:COMPUTERNAME\$env:USERNAME
